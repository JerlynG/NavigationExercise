		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpnavigationgollayan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpnavigationgollayan-display": {
								"semanticObject": "zbtpnavigationgollayan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.navigationgollayan",
									"url": sap.ui.require.toUrl("zbtp/navigationgollayan")
								}
							}
						}
					}
